...
namespace grpcArachne {
  public static partial class AtributFormBB
  {
    static readonly string __ServiceName = "AtributFormBB";
    ...
    {
      get { return global::grpcArachne.AtributFormBarangBaruReflection.Descriptor.Services[0]; }
    }

    /// <summary>Base class for server-side implementations of AtributFormBB</summary>
    [grpc::BindServiceMethod(typeof(AtributFormBB), "BindService")]
    public abstract partial class AtributFormBBBase
    {
    ...
    public static grpc::ServerServiceDefinition BindService(AtributFormBBBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    public static void BindService(grpc::ServiceBinderBase serviceBinder, AtributFormBBBase serviceImpl)
    {
