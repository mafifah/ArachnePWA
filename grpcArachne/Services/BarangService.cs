    ...
    public class BarangService : T1Barang.T1BarangBase
    {
            ...
            try {
                ...
                if (qryT5StokGudang.Any())
                {
                    var qry = (from T5STokGudang in _db.T5StokGudangDbSet
                               where T5STokGudang.IdSatuan == request.IdSatuan
                               && T5STokGudang.IdGudang == request.IdGudang
                               select new { T5STokGudang.IdSatuan, T5STokGudang.IdGudang,
                                   T5STokGudang.StokBaru, T5STokGudang.StokBaruLokasi, T5STokGudang.StokBaruNominal,
                                   T5STokGudang.StokBekas, T5STokGudang.StokBekasLokasi, T5STokGudang.StokBekasNominal,
                                   T5STokGudang.StokRusak, T5STokGudang.StokRusakLokasi, T5STokGudang.StokRusakNominal,
                                   T5STokGudang.WaktuProses, T5STokGudang.IdOperator, T5STokGudang.Synchronise }).FirstOrDefault();
        ...
        private async Task Send(long IdSatuan)
        {
            try
            {
                ...
                var hubConnection = new HubConnectionBuilder().WithUrl("http://localhost:34743/notified").Build();
